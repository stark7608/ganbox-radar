...
const CACHE = 'gbr-v2';
self.addEventListener('install',  e=>{ e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['/ganbox-radar/','/ganbox-radar/index.html','/ganbox-radar/manifest.json']))); self.skipWaiting(); });
